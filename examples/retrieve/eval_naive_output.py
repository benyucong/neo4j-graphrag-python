...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Evaluate a single naive prediction file (answers_merged_naive.jsonl) against Benyucong/vanilla-hop2."
    )
    p.add_argument(
        "--pred", default="outputs/answers_merged_naive.jsonl", help="Predictions JSONL path (default outputs/answers_merged_naive.jsonl)"
    )
