...
def parse_args():
    p = argparse.ArgumentParser(
        description="Batch: read dataset JSONL, run merged 2-hop queries (random-pruned), and generate LLM answers."
    )
...
def run_query_merged(
    ...
    // ---------- Combine hops and compute scores (for reporting only) ----------
    WITH s, r1, m, r2, o, a1, b1, c1, a2, b2, c2,
